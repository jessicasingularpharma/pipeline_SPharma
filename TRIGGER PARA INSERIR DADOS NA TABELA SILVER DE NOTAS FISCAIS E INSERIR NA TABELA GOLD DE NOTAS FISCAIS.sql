CREATE OR REPLACE FUNCTION inserir_notasfiscais()
RETURNS TRIGGER AS $$
BEGIN
...
CREATE OR REPLACE FUNCTION inserir_itensdasnotasfiscais()
RETURNS TRIGGER AS $$
BEGIN
...
CREATE OR REPLACE FUNCTION inserir_combined_notasfiscais()
RETURNS TRIGGER AS $$
BEGIN
...
CREATE TRIGGER trg_inserir_notasfiscais
AFTER INSERT ON temporary."FC11000"
FOR EACH ROW
EXECUTE FUNCTION inserir_notasfiscais();

CREATE TRIGGER trg_inserir_itensdasnotasfiscais
AFTER INSERT ON temporary."FC11100"
FOR EACH ROW
EXECUTE FUNCTION inserir_itensdasnotasfiscais();

CREATE TRIGGER trg_inserir_combined_notasfiscais
AFTER INSERT ON silver.notasfiscais
FOR EACH ROW
EXECUTE FUNCTION inserir_combined_notasfiscais();
